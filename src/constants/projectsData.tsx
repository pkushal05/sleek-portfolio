...
const PROJECTS = [
    ...
    },
    {
        ...
        overview:
            "A modern and sleek portfolio website built to showcase my projects, skills, and experience for co-op recruiting. Designed with smooth animations and a clean, responsive interface.",
        image: portfolio,
        techStack: [
            { name: "React", icon: react },
        ...
        features: [
            ...
            "Interactive UI components from Aceternity UI library",
            "Type-safe development with TypeScript",
            "Clean and modern design with Tailwind CSS",
            "Optimized performance with lazy loading and code splitting",
            "SEO-friendly with proper meta tags and Open Graph images",
        ],
        challenges: [
            "Creating fluid animations with GSAP",
            "Adapting to TypeScript's strict typing system after primarily working with JavaScript, especially for complex props and state management",
            "Balancing aesthetic design with fast load times and optimal Lighthouse scores",
            "Implementing TypeScript strict mode for better type safety and fewer runtime errors",
            "Designing an intuitive navigation experience that showcases projects effectively",
        ...
        links: [
            ...
            {
                href: "https://github.com/pkushal05/sleek-portfolio",
                icon: (
                    <svg
                        className="h-5 w-5 md:h-6 md:w-6"
                        xmlns="http://www.w3.org/2000/svg"
