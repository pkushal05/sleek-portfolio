  ...
  "active:scale-95 [&_svg]:-mx-0.5 relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      size: {
        ...
        iconlg: "size-10 sm:size-9",
        iconsm: "size-8 sm:size-7",
        iconxl:
        ...
        xs: "h-5 gap-1 rounded-md px-[calc(--spacing(2)-2px)] text-xs before:rounded-[calc(var(--radius-md)-1px)] md:h-6 md:text-xs [&_svg:not([class*='size-'])]:size-4 sm:[&_svg:not([class*='size-'])]:size-3.5",
      },
      variant: {
        default:
        ...
        ghost:
          "border-primary/20 active:border-primary/50 data-pressed:bg-accent",
        ...
        logo: "border-primary border-dashed bg-primary/5 text-primary hover:bg-primary/10 [:active,[data-pressed]]:bg-primary/20 cursor-pointer h-auto py-1 px-2 md:px-2 rounded-md before:rounded-[calc(var(--radius-md)-1px)] align-baseline leading-tight gap-1.5 text-xs md:text-sm [&_svg:not([class*='size-'])]:size-[1em]",
      },
    },
  }
);
