      ...
      <div className="h-full w-full">
        <div className="flex flex-col gap-y-5">
          <div className="relative h-28 w-28 rounded-full">
            <img src={react} alt="" className="h-full w-full object-fill" />
          ...
          <div>
            <h1 className="text-2xl md:text-3xl leading-tight tracking-tight">
              <span className="font-bold text-muted-foreground">Hi, I'm</span>{" "}
              <span className="text-3xl md:text-5xl font-medium">Kushal</span>{" "}
